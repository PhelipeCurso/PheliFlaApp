...
class SuperMundialPage extends StatefulWidget {
  @override
  _SuperMundialPageState createState() => _SuperMundialPageState();
}

class _SuperMundialPageState extends State<SuperMundialPage> {
  List<Game> games = [];
  bool isLoading = true;
